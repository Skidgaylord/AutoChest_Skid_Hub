...
Converted["_SkidLogo"].Image = "rbxassetid://15033356012"
Converted["_SkidLogo"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_SkidLogo"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_SkidLogo"].BorderSizePixel = 0
Converted["_SkidLogo"].Position = UDim2.new(0.0337078646, 0, 0.107784428, 0)
Converted["_SkidLogo"].Size = UDim2.new(0, 90, 0, 90)
Converted["_SkidLogo"].Name = "SkidLogo"
Converted["_SkidLogo"].Parent = Converted["_Frame1"]

Converted["_UICorner1"].Parent = Converted["_SkidLogo"]
    ...
    function thisCode()
        ...
        function AllowRunServiceBind.OnInvoke(args)
            ...
            CoreGui:SetCore("SendNotification", {
                Title = "Skid Hub",
                Text = "Skid Hub Auto Chest is best Script!!!",
                Duration = math.huge,
